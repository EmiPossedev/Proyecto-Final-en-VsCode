...
void gestionarPaciente(Paciente* p){
    ...
    do
    {
        ...
        case 5:
            ...
            cout << "2. Borrar y reemplazar observaciones" << endl;
...
void registrarkinesiologo (Consultorio &sistema){
    ...
    cin.ignore();
    cout << "Ingrese nombre: "; getline(cin, textoAux);
    k->setNombre(textoAux);
    // Pido el apellido
    cout << "Ingrese apellido: "; getline(cin, textoAux);
    k->setApellido(textoAux);
    // Pido el teléfono
    cout << "Ingrese Telefono (solo numeros): "; cin >> numeroAux;
